...
extension LocalCategoryQuerySortBy
  ...
  QueryBuilder<LocalCategory, LocalCategory, QAfterSortBy> sortByCategoryId() {
    return QueryBuilder.apply(this, (query) {
...
extension LocalCategoryQuerySortThenBy
  ...
  QueryBuilder<LocalCategory, LocalCategory, QAfterSortBy> thenByCategoryId() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'categoryId', Sort.asc);
    });
  }
...
extension LocalCategoryQueryWhereDistinct
  ...
  QueryBuilder<LocalCategory, LocalCategory, QDistinct> distinctByCategoryId(
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
...
extension LocalCategoryQueryProperty
  ...
  QueryBuilder<LocalCategory, String?, QQueryOperations> categoryIdProperty() {
    return QueryBuilder.apply(this, (query) {
